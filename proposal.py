...
КРИТИЧЕСКИ ВАЖНО:
- Включи КАЖДЫЙ формат/услугу, которую клиент упомянул. НЕ пропускай ни одного.
- Если клиент написал 3 формата — в services должно быть минимум 3 записи.
- Если клиент написал 5 форматов — 5 записей. Без исключений.
...
ОТВЕТЬ СТРОГО В JSON:
{
  ...
  "intro": "вступление НА РУССКОМ (2-3 предложения, профессиональное обращение к клиенту)",
  "services": [
    {"name": "Услуга", "description": "Что входит (кратко)", "price_from": 300, "price_to": 500, "unit": "за сюжет"}
  ],
  "packages": [
...
Повторяю: КАЖДЫЙ формат клиента = отдельная строка в services."""
